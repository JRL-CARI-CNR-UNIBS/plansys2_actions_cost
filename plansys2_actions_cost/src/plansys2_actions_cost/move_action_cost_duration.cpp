...
#include "plansys2_actions_cost/move_action_cost_duration.hpp"

namespace plansys2_actions_cost
{

void MoveActionCostDuration::initialize(
...
ActionCostPtr MoveActionCostDuration::compute_cost_function()
{
