...
#ifndef PLANSYS2_ACTIONS_COST__MOVE_THROUGH_POSES_ACTION_COST_BASE_HPP_
#define PLANSYS2_ACTIONS_COST__MOVE_THROUGH_POSES_ACTION_COST_BASE_HPP_
...
class MoveThroughPosesActionCostBase : public ActionCostBase<std::vector<geometry_msgs::msg::PoseStamped>>
{
public:
  MoveThroughPosesActionCostBase() {}
  ~MoveThroughPosesActionCostBase() {}
...
protected:
  using ComputePathThroughPosesGoalHandle =
    rclcpp_action::ClientGoalHandle<nav2_msgs::action::ComputePathThroughPoses>;
  using ComputePathThroughPosesFeedback =
    const std::shared_ptr<const nav2_msgs::action::ComputePathThroughPoses::Feedback>;
  using ComputePathThroughPosesResult =
    const ComputePathThroughPosesGoalHandle::WrappedResult;

  using ActionThroughPoses = nav2_msgs::action::ComputePathThroughPoses;

  nav_msgs::msg::Path::SharedPtr path_ptr_;
  rclcpp_action::Client<ActionThroughPoses>::SharedPtr compute_path_action_client_;
...
#endif  // PLANSYS2_ACTIONS_COST__MOVE_THROUGH_POSES_ACTION_COST_BASE_HPP_
